...
public final class AWSCommonParams {
  ...
  // "cloudformation_" prefix is for backward compatibility

  public static final String REGION_NAME_PARAM = "cloudformation_region_name";
  public static final String REGION_NAME_LABEL = "AWS region";

  public static final String CREDENTIALS_TYPE_PARAM = "cloudformation_credentials_type";
  public static final String CREDENTIALS_TYPE_LABEL = "Credentials type";
  public static final String TEMP_CREDENTIALS_OPTION = "cloudformation_temp_credentials";
  public static final String TEMP_CREDENTIALS_LABEL = "Temporary credentials";
  public static final String ACCESS_KEYS_OPTION = "cloudformation_access_keys";
  ...
  public static final String ACCESS_KEY_ID_PARAM = "cloudformation_access_key_id";
  public static final String ACCESS_KEY_ID_LABEL = "Access key ID";
  public static final String SECURE_SECRET_ACCESS_KEY_PARAM = "secure:cloudformation_secret_access_key";
  public static final String SECRET_ACCESS_KEY_PARAM = "cloudformation_secret_access_key";
  public static final String SECRET_ACCESS_KEY_LABEL = "Secret access key";

  public static final String IAM_ROLE_ARN_PARAM = "cloudformation_iam_role_arn"; 
  public static final String IAM_ROLE_ARN_LABEL = "IAM role ARN";
  public static final String EXTERNAL_ID_PARAM = "cloudformation_external_id";
