...
import jetbrains.buildServer.runner.cloudformation.CloudFormationUtil;
import jetbrains.buildServer.runner.cloudformation.ParametersValidator;
...
public class CloudFormationRunType extends RunType {
  @NotNull
  ...
  public CloudFormationRunType(@NotNull RunTypeRegistry registry,
  ...
  public String describeParameters(@NotNull Map<String, String> parameters) {
    ...
    return invalids.isEmpty() ? "CloudFormation Stack" : CloudFormationUtil.printStrings(invalids.values());
  }
}
