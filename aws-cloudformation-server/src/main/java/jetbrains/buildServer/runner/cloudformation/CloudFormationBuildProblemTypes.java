...
import jetbrains.buildServer.runner.cloudformation.CloudFormationConstants;
...
public class CloudFormationBuildProblemTypes {

  public CloudFormationBuildProblemTypes(@NotNull ExtensionHolder extensionHolder) {
    register(CloudFormationConstants.TIMEOUT_BUILD_PROBLEM_TYPE, "CloudFormation timeout", extensionHolder);
    register(CloudFormationConstants.FAILURE_BUILD_PROBLEM_TYPE, "CloudFormation failure", extensionHolder);
