...
<tr>
    ...
    <td><props:textProperty name="${env_name_param}" className="longField" maxlength="256"/><a href="http://console.aws.amazon.com/cloudformation" target="_blank">Open CloudFormation Console</a>
